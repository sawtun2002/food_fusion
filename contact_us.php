...
// ၁။ Login စစ်ဆေးခြင်း နှင့် Navbar အတွက် User Data ဆွဲထုတ်ခြင်း
...
<head>
    ...
    <style>
        /* index.php နဲ့ Navbar တစ်ထပ်တည်းတူစေရန် Global Styles */
        :root { --coral: #ff5733; --honey: #ffb347; --navy: #1a1a2e; --cream: #fffdfa; }
        
        /* Font ကို index.php အတိုင်း Poppins ပြောင်းလိုက်ပါပြီ */
        body { background-color: var(--cream); font-family: 'Poppins', 'Segoe UI', sans-serif; color: #444; }

      
        /* --- Contact Page မူရင်း Body Content Styles --- */
        .contact-header {
        ...
        .map-container { border-radius: 30px; overflow: hidden; height: 400px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); }
    </style>
</head>
<body>
        ...
        <div class="col-md-4">
            ...
            <div class="contact-card">
                ...
                <div class="mt-3">
                    ...
                    <a href="viber://chat?number=+95912345678" class="social-link viber" title="Viber"><i class="bi bi-messenger"></i></a>

                    <a href="https://t.me/foodfusion_official" class="social-link telegram" title="Telegram"><i class="bi bi-telegram"></i></a>

                    <a href="tel:+95912345678" class="social-link phone" title="Call Us"><i class="bi bi-telephone-fill"></i></a>
        ...
        <div class="col-lg-6">
            ...
            <div class="map-container">
                ...
                <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d122283.78443729!2d96.129124!3d16.801264!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30c1ec0930d6363d%3A0xc397443818e6988c!2sYangon!5e0!3m2!1sen!2smm!4v1705000000000!5m2!1sen!2smm"
