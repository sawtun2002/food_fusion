...
$current_role = "";
$current_user_img = "";
$current_user_email = ""; // Variable to store user email

if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    // Fetch username, role, image, and email from database
    $user_query = $conn->prepare("SELECT username, role, image, email FROM users WHERE id = ?");
...
// 2. Logic to Save Message to Database
$status_message = "";
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['send_contact'])) {
    ...
    $stmt->bind_param("issss", $logged_in_id, $name, $email, $subject, $message);

    if ($stmt->execute()) {
        $status_message = "<div class='alert alert-success mt-3'>Message sent successfully! Thank you.</div>";
    } else {
        $status_message = "<div class='alert alert-danger mt-3'>Error: Something went wrong. Please try again.</div>";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .newsletter-section { background: var(--navy); color: white; padding: 60px; border-radius: 40px; margin-top: 50px; }
...
<section class="contact-header">
    <div class="container">
        ...
        <p class="lead opacity-75">Have questions about our recipes or services? We're here to help!</p>
    </div>
</section>
    ...
    <div class="row g-5 align-items-stretch">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="name@example.com" 
                                   value="<?php echo $current_user_email; ?>" required>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12 text-end">
                            <button type="submit" name="send_contact" class="btn btn-send">Send Message <i class="bi bi-send ms-2"></i></button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="col-lg-6">
            <div class="map-container">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d122283.76566431945!2d96.06209590822189!3d16.83296229569722!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30c1ec216068224b%3A0x644265f04b1263c9!2sYangon!5e0!3m2!1sen!2smm!4v1700000000000!5m2!1sen!2smm"
    ...
    <div class="newsletter-section text-center shadow-lg">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <p class="mb-5 text-white-50 fs-5">Get the latest recipes and healthy tips delivered straight to your inbox.</p>
